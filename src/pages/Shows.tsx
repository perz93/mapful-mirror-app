import { Theater, Calendar, Clock, ArrowLeft } from 'lucide-react';
  ...
  const events = [
    {
      ...
      venue: "Théâtre de l'Humour",
      date: "Ven, 22 Nov",
      time: "21:00",
      price: "15 000 FCFA",
      image: "https://images.unsplash.com/photo-1585699324551-f6c309eedeca?w=400&h=400&fit=crop"
    },
    {
      id: 23,
      title: "Spectacle de Magie",
      venue: "Salle des Étoiles",
      date: "Sam, 23 Nov",
      time: "20:00",
      price: "18 000 FCFA",
        ...
        <header className="sticky top-0 z-10 backdrop-blur-xl bg-white/80 dark:bg-stone-900/80 border-b border-stone-200/50 dark:border-stone-800/50">
          <div className="flex items-center gap-4 px-4 py-4">
            ...
            <div className="flex items-center gap-3">
              <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-gradient-to-br from-indigo-500/10 to-indigo-500/5">
                <Theater size={22} className="text-indigo-500" strokeWidth={1.5} />
              </div>
              <h1 className="text-2xl font-bold text-stone-900 dark:text-white">Spectacles</h1>
            </div>
          </div>
        </header>
