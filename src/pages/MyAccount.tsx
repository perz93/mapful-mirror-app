      ...
      <div className="relative z-10 min-h-screen flex flex-col max-w-md mx-auto">
        ...
        <div className="flex flex-col items-center px-6 pt-4">
          ...
          <div className="grid grid-cols-3 gap-3 w-full mb-6">
            <div className="flex flex-col items-center gap-1 rounded-2xl backdrop-blur-2xl bg-white/30 border border-white/30 shadow-[0_8px_32px_-8px_rgba(0,0,0,0.15)] p-3">
          ...
          {/* Tabs */}
          <div className="flex w-full rounded-2xl backdrop-blur-2xl bg-white/30 border border-white/30 shadow-[0_8px_32px_-8px_rgba(0,0,0,0.15)] p-1 mb-6">
            {tabs.map((tab) => {
              const Icon = tab.icon;
          ...
          <div className="w-full pb-8">
            {activeTab === 'events' && (
              <div>
                ...
                {userEvents.length === 0 ? (
                  <div className="rounded-2xl backdrop-blur-2xl bg-white/30 border border-white/30 shadow-[0_8px_32px_-8px_rgba(0,0,0,0.15)] p-8 text-center">
