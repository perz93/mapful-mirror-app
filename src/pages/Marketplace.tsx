            ...
            {listings.map((listing, index) => {
              ...
              return (
                <Link
                  ...
                  className="group relative overflow-hidden rounded-2xl bg-white/30 dark:bg-stone-900/30 backdrop-blur-2xl shadow-[0_8px_32px_-8px_rgba(0,0,0,0.15)] border border-white/30 dark:border-white/10 animate-fade-in transition-all duration-300 hover:shadow-xl hover:-translate-y-0.5 active:scale-[0.98]"
                >
                  {listing.image_url && (
