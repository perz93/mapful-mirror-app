  ...
  const events = [
    {
      ...
      venue: "Église Évangélique",
      date: "Dim, 17 Nov",
      time: "09:00",
      price: "Gratuit",
      image: "https://images.unsplash.com/photo-1438032005730-c779502df39b?w=400&h=400&fit=crop"
    },
    {
      id: 25,
      title: "Concert Gospel",
      venue: "Cathédrale St-Paul",
      date: "Sam, 23 Nov",
      time: "18:00",
      price: "5 000 FCFA",
          ...
          <div className="flex items-center gap-4 px-4 py-4">
            ...
            <div className="flex items-center gap-3">
              <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-gradient-to-br from-purple-500/10 to-purple-500/5">
                <Church size={22} className="text-purple-500" strokeWidth={1.5} />
              </div>
              <h1 className="text-2xl font-bold text-stone-900 dark:text-white">Religieux</h1>
            </div>
          </div>
        </header>
