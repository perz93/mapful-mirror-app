import { Coffee, Calendar, Clock, ArrowLeft } from 'lucide-react';
...
const Brunch = () => {
  const events = [
    ...
    },
    {
      ...
      time: "10:30",
      price: "18 000 FCFA",
      image: "https://images.unsplash.com/photo-1551218372-a8789b81b253?w=400&h=400&fit=crop"
    },
    {
      id: 23,
      title: "Brunch Végétarien",
      venue: "Green Garden",
      date: "Sam, 30 Nov",
      time: "11:30",
      price: "10 000 FCFA",
          ...
          <div className="flex items-center gap-4 px-4 py-4">
            ...
            <div className="flex items-center gap-3">
              <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-gradient-to-br from-amber-500/10 to-amber-500/5">
                <Coffee size={22} className="text-amber-500" strokeWidth={1.5} />
              </div>
              <h1 className="text-2xl font-bold text-stone-900 dark:text-white">Brunch</h1>
            </div>
          </div>
        </header>
