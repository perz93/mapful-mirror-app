...
const SearchBar = () => {
  return (
    <div className="fixed left-0 right-0 top-0 z-30 max-w-md mx-auto bg-gradient-to-b from-white via-white/80 to-transparent dark:from-stone-900 dark:via-stone-900/80 backdrop-blur-sm">
