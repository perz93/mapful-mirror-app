...
const ManageEventCard = ({ event, onDeleted, onUpdated }: ManageEventCardProps) => {
  ...
  return (
    <div className="w-full pointer-events-auto touch-auto">
      <div className="flex items-stretch justify-between gap-3 rounded-2xl backdrop-blur-2xl bg-white/30 dark:bg-stone-900/30 p-4 shadow-[0_8px_32px_-8px_rgba(0,0,0,0.15)] border border-white/30 dark:border-white/10">
