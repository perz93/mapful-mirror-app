...
const BottomNavigation = ({ className = "" }: BottomNavigationProps) => {
  ...
  return (
    <>
      ...
      <div className={`fixed bottom-0 left-0 right-0 max-w-md mx-auto flex-shrink-0 z-40 pb-safe ${className}`}>
        <div className="mx-3 mb-1 h-[68px] rounded-xl backdrop-blur-xl bg-white/80 dark:bg-stone-900/80 shadow-2xl border border-stone-200/50 dark:border-stone-700/50 overflow-hidden">
