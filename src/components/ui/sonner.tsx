  ...
  return (
    <Sonner
      ...
      toastOptions={{
        classNames: {
          toast:
            "group toast group-[.toaster]:rounded-2xl group-[.toaster]:border group-[.toaster]:border-white/30 group-[.toaster]:bg-white/30 group-[.toaster]:backdrop-blur-2xl group-[.toaster]:text-stone-900 group-[.toaster]:shadow-[0_8px_32px_-8px_rgba(0,0,0,0.15)]",
